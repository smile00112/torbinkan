	...
	public function index() {
	   ...
	   $this->document->addStyle('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/news.css');
		...
		if ($news_info) {
			...
			$this->data['min_height'] = $this->config->get('news_popup_height');
			...
			$this->response->setOutput($this->render());
				...
				$this->data['widthimg']			= $this->config->get('news_popup_width');
				$this->data['heightimg']		= $this->config->get('news_popup_height');
