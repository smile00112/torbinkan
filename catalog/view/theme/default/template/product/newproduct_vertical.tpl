...
<!-- PAGE HEADER ================================================== -->
<link rel="stylesheet" href="catalog/view/theme/default/stylesheet/configvertical/basevertical.css">
<link rel="stylesheet" href="catalog/view/theme/default/stylesheet/configvertical/skeletonvertical.css">
...
<div class="three pccolumns clearfix alpha omega">
    <ul>
        <?php if ($options)
        { $ot = 0; ?>
...
<!-- BUTTONS -->
<div class="pcbuttons">
    <span class="pop-content pcprevious" align="left" id="previous"><a>Previous</a></span>
...
<!-- PRODUCT INFORMATION -->
<!-- Product details -->
<div class="eight pccolumns pcdescription alpha omega">
    ...
    <div class="pop-content">
        ...
        <div class="indent-content">
            ...
            <div class="row">
            	<div class="two-third pccolumn alpha omega">
        ...
        <div>
            ...
            <label style="display:inline">
                ...
                <input class="customprice" value="<?php echo number_format($price_tax, 2, '.', ''); ?>" readonly="readonly"
                       id="priceupdate"/>
        ...
        <?php } ?>
            ...
            <!-- Image and product -->
            <div class="row">
                <div class="two-thirds pccolumn alpha omega">
                    <?php if ($thumb || $images) { ?>
                    <?php if ($thumb) { ?>
                    <div class="zoom-section">
                    <div class="zoom-small-image image">
                    <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class='cloud-zoom' id='zoom1' rel="adjustX: 57, adjustY:3"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image"/></a>
                    </div>
                    </div>
                    <?php } ?>
                    <?php if ($images) { ?>
        ...
        <div class="pcprice"><?php echo $text_price; ?>
            ...
            <?php echo $price; ?>
            <?php } else { ?>
            <span class="pcprice-old"><?php echo $price; ?></span> <span class="price-new"><?php echo $special; ?></span>
            <?php } ?>
            <?php if ($tax) { ?>
