...
<div class="option_name"><span><?php echo $text_price_range?></span><i class="fa fa-angle-up"></i></div>
...
<div class="option_box">
	<div class="option_name <?php if(!$expanded_categories){echo "hided";}?>"><span><?php echo $text_categories; ?></span><i class="fa fa-angle-up"></i></div>
	...
	<?php if($manufacturers) { ?>
<div class="option_box">
	<div class="option_name <?php if(!$expanded_manufacturer){echo "hided";}?>"><span><?php echo $text_manufacturers; ?></span><i class="fa fa-angle-up"></i></div>
	...
	<?php } ?>
		...
		<div class="attribute_box <?php if($attr_group=="0") echo "option_box"; ?>">
			...
			<div class="option_name <?php if(!$attribute_value['expanded']){echo "hided";}?>"><span><?php echo $attribute_value['name']; ?></span><i class="fa fa-angle-up"></i></div>
	...
	<?php foreach($options as $option) { ?>
	<div class="option_box">
		<div class="option_name <?php if(!$option['expanded']){echo "hided";}?>"><span><?php echo $option['name']; ?></span><i class="fa fa-angle-up"></i></div>
