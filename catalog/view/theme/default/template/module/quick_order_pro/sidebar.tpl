<div class="quick-order-pro <?php echo $class; ?> item-<?php echo $item_id; ?>">
	<div class="header">
	...
	<div class="product-info-block">
		<p class="name"><?php echo $product_info['name']; ?> &times; <span class="quantity"><?php echo $product_info['quantity']; ?></span></p>
		<?php if ($template_info['show_option']) { ?>
		<ul class="options">
		...
		<form action="" method="post" enctype="multipart/form-data">
			<div class="rows">
				...
				<div class="row button">
					<?php if ($total) { ?>
					<span class="total"><span class="total-label"><?php echo $text_total; ?></span> <b><?php echo $total; ?></b></span>
					<?php } ?>
