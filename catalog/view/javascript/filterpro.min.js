        ...
        $.each(g.totals_data.manufacturers, function (f, k) {
            if (k.id) {
                ...
                if (j.get(0).tagName == "OPTION") {
                    j.html($("#m_" + k.id).val() + '<span class="count">' + k.t + '</span>')
                } else {
                    $('label[for="manufacturer_' + k.id + '"]').html($("#m_" + k.id).val() + '<span class="count">' + k.t + '</span>')
                }
            }
        });
            ...
            if (k.id) {
                ...
                if (f.length) {
                    ...
                    if (f.get(0).tagName == "OPTION") {
                       f.html($("#o_" + k.id).val() + '<span class="count">' + k.t + '</span>') 
                    } else {
                        $('label[for="option_value_' + k.id + '"]').html($("#o_" + k.id).val() + '<span class="count">' + k.t + '</span>')
                    }
                }
            }
        });
