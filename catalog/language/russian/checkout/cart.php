...
$_['text_items']    = '<a href="/index.php?route=checkout/cart" class="cart"><i class="fa fa-shopping-cart"></i><span class="text">Моя корзина</span><span class="qnt_cont"><span class="qnt">%s</span> </a></span> <span class="sum_cont"><span class="sum">%s</span></span>';
