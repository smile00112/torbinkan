...
public function getPriseSubscribers() {
				$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "pricesubscribe");

				return $query->rows;
			}
			
public function getSpeicalSubscribers() {
				$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "specsubscribe");
