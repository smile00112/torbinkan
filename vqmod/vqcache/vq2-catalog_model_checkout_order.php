...
class ModelCheckoutOrder extends Model {
	...
	public function getOrder($order_id) {
       ...
       public function confirm($order_id, $order_status_id, $comment = '', $notify = false, $attachment = '') { 
...
if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mail/order.tpl')) {
    ...
    $html = $template->fetch('default/template/mail/order.tpl');
                ...
                $text .= $language->get('text_new_name') . ' ' . $order_info['shipping_firstname'] .' '. $order_info['shipping_lastname'] .  "\n";
                $text .= $language->get('text_new_email') . ' ' . $order_info['email'] . "\n";
                $text .= $language->get('text_new_payment_address') . ' ' . $order_info['shipping_address_1'] . "\n";
                $text .= $language->get('text_new_city') . ' ' . $order_info['shipping_city'] . "\n";
                $text .= $language->get('text_new_country') . ' ' . $order_info['shipping_country'] . "\n";
