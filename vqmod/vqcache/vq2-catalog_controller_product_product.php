...
$this->data['button_out_of_stock'] = $this->language->get('button_out_of_stock');
	      ...
	      $this->data['quantity'] = $product_info['quantity'];
			...
			if (($this->config->get('config_customer_price') && $this->customer->isLogged()) || !$this->config->get('config_customer_price')) {
			$this->data['opt_price'] = $this->currency->format($this->tax->calculate($product_info['price'] * (100 - $product_info['ean']) * 0.01));
			}			
			...
			if ((float)$product_info['special']) {
				$this->data['saving'] = $this->currency->format((($product_info['special'])-($product_info['price']))*(-1)) ;
			} else {
				$this->data['special'] = false;
			}
					...
					foreach ($option['option_value'] as $option_value) {
						if (!$option_value['subtract'] || ($option_value['quantity'] > 0)) {
							if($option['type'] == 'select'){
									$option_price = $product_info['price'];
									if ($option_value['price_prefix'] == '+') {
										$option_price += $option_value['price'];
									} elseif ($option_value['price_prefix'] == '-') {
										$option_price -= $option_value['price'];
									}
							     //echo $option_value['price'].'|'.$option_value['points'].'|'.$option_value['price_discount'].'<br>';
								...
								$option_value_data[] = array(
                                    ...
                                    'price_digits'               => $product_info['price']+$option_value['price'],
									...
									'price_roznic' => $this->currency->format($option_price * (100 - $product_info['ean']) * 0.01), 
