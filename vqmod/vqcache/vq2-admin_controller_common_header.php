...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['heading_title'] = $this->language->get('heading_title');
	     ...
	     $this->data['text_form_data'] = $this->language->get('text_form_data');
	     $this->data['form'] = $this->url->link('catalog/form','token='.$this->session->data['token'], 'SSL');
	     $this->data['form_data'] = $this->url->link('catalog/formdata','token='.$this->session->data['token'], 'SSL');
...
$this->data['text_cachemanager'] = $this->language->get('text_cachemanager');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['batch_editor'] = $this->url->link('module/batch_editor', 'token=' . $this->session->data['token'], 'SSL');
