...
if(file_exists(DIR_SYSTEM . 'library/MPDF56/mpdf.php')) {
					require_once(VQMod::modCheck(DIR_SYSTEM . 'library/MPDF56/mpdf.php'));
					require_once(VQMod::modCheck(DIR_SYSTEM . 'library/myoc/barcode.php'));
				}
?>