      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <table class="list">
          ...
          <tbody>
            ...
            <?php foreach ($form_datas as $form_data) { ?>

            <tr>

              <td style="text-align: center;"><?php if ($form_data['selected']) { ?>

                <input type="checkbox" name="selected[]" value="<?php echo $form_data['form_data_id']; ?>" checked="checked" />

                <?php } else { ?>

                <input type="checkbox" name="selected[]" value="<?php echo $form_data['form_data_id']; ?>" />

                <?php } ?></td>

              <td class="left"><?php echo $form_data['date_added']; ?></td>

              <td class="right"><?php echo $form_data['status']; ?></td>

              <td class="right"><?php foreach ($form_data['action'] as $action) { ?>
