...
class ControllerSaleContact extends Controller {
	...
	public function index() {
		...
		$this->data['text_speical'] = $this->language->get('text_speical');
			...
			if (!$json) {
				...
				switch ($this->request->post['to']) {
					case 'price':
					   ...
					   $results = $this->model_sale_customer->getPriseSubscribers();
				...
				case 'speical':
					   ...
					   $results = $this->model_sale_customer->getSpeicalSubscribers();
						foreach ($results as $result) {
							$emails["s".$result['id']] = $result['email_id'];
						}
						break;
