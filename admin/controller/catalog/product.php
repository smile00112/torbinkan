...
//
$product_model_options = array();
$product_model_options = $this->model_catalog_product->getProductModelOption($result['product_id']);
//	
			...
			foreach ($product_specials  as $product_special) {
      		...
      		$this->data['products'][] = array(
				...
				'status'     => ($result['status'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled')),
				'selected'   => isset($this->request->post['selected']) && in_array($result['product_id'], $this->request->post['selected']),
				'model_option'      => $product_model_options,
				'action'     => $action
			);
    	}
  	...
  	protected function getForm() {
		...
		if (isset($this->error['mini_description'])) {
			$this->data['error_mini_description'] = $this->error['mini_description'];
		} else {
			$this->data['error_mini_description'] = array();
		}
