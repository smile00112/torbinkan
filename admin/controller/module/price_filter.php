...
class ControllerModulePriceFilter extends Controller {
    ...
    public function index() {
        ...
        $this->data['action'] = $this->url->link('module/price_filter', 'token=' . $this->session->data['token'], 'SSL');

        $this->data['cancel'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');

        $this->data['modules'] = array();

        if (isset($this->request->post['price_filter_module'])) {
            $this->data['modules'] = $this->request->post['price_filter_module'];
        } elseif ($this->config->get('price_filter_module')) {
            $this->data['modules'] = $this->config->get('price_filter_module');
        }
        ...
        $this->template = 'module/price_filter.tpl';
        $this->children = array(
            'common/header',
            'common/footer'
        );
